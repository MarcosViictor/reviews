...
urlpatterns = [
    ...
    path('comments/overview/movies/<int:id_overview_movie>/', CommentsOverviewMovieView.as_view(), name='comments-overview-movie'),
    path('comments/overview/movies/detail/<int:id>/', CommentsOverviewMovieDetailView.as_view(), name='comments-overview-movie-detail'),
