...
class SearchSerieView(APIView):

    def get(self, request, *args, **kwargs):
        url = 'https://api.themoviedb.org/3/search/tv?query=severance'
        ...
        search_series = response.json()

        return Response(search_series, status=status.HTTP_200_OK)
